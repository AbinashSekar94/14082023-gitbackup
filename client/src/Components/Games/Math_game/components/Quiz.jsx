...
class Quiz extends React.Component {
  ...
  nextProblem = () => {
    setTimeout(() => {
      ...
      if (this.props.lifes > 0 && this.answerInput) {
  ...
  render() {
    return (
      <section className="Mathgame-show-up">
        <div>
          {this.state.modalShowing ? (
            this.state.modal
          ) : (
            <div className="Mathgame_quiz">
...
//     this._isMounted && this.props.onCorrectAnswer();
...
//       if (this.props.lifes > 0 && this.answerInputRef.current) {
//         this.focusAnswerInput();
//       }
//     }, 2500);
//   };
